...
Output
![Deskripsi gambar](Tp_02.png)

alt text

Deskripsi Program

Program ini menjalankan perkalian semua bilangan dalam array. Ini akan bekerja untuk bilangan positif, nol, dan negatif.

Dengan membuat inisiasi array di awal dengan menggunakan const arr = [2,0,26,28,-2]
